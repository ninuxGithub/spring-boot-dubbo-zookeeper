...
public class QueueReceive {
    ...
    public void condum() throws JMSException, InterruptedException {
        ...
        for (int i=0; i<2; i++){
            MessageConsumer consumer = session.createConsumer(queue,"age>5");
                ...
                public void onMessage(Message message) {
                    if (message instanceof MapMessage){
                        ...
                        try {
                            ...
                            String groupID = mapMessage.getStringProperty("JMSXGroupID");
                            System.out.println(javaProperty  + "            "+map + " group："+ groupID);
