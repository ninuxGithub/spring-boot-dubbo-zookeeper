...
//	}
//
//	public void setShardJedisPool(ShardedJedisPool shardJedisPool) {
...
//	 *            对应的value
//	 */
//	public void pushPipeLine(byte[] redisKey, byte[] redisValue) {
//		// 多线程操作时同步
...
//			cachedCount++;
//			try {
//				logger.info("缓存" + new String(redisKey, "UTF-8") + "成功");
//			} catch (UnsupportedEncodingException e) {
//				logger.error("字节流转换字符串异常", e);
//			}
//
//			// 刷新缓存到Redis中去
//			if (null != pipeLine && cachedCount >= 0) {
//				cachedCount = 0;
//				pipeLine.sync();
//				pipeLine = null;
//				if (null != jedis) {
//					jedis.close();
//				}
//				logger.info("将管道中缓存的数据刷新到redis中......");
//			}
//		}
//	}
