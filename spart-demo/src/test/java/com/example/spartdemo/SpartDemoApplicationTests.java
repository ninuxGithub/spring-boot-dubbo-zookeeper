...
import com.example.spart.SparkDemoApplication;
...
public class SpartDemoApplicationTests {

    private static final Logger logger = LoggerFactory.getLogger(SpartDemoApplicationTests.class);
    ...
    public void contextLoads() throws InterruptedException {
        JavaStreamingContext jsc = new JavaStreamingContext(sparkContext, Durations.seconds(10));//批间隔时间
